...
_db_stuff = {
    ...
    Hash.HvbSoCD:                   {'db_name': 'hvb_socd',                  'type': 'int'},
    ...
    Hash.GpsElevation:              {'db_name': 'gps_elevation',             'type': 'float'},
    ...
    Hash.GpsElevationMin:           {'db_name': 'gps_elevation_min',         'type': 'float'},
    Hash.GpsElevationMax:           {'db_name': 'gps_elevation_max',         'type': 'float'},
    ...
    Hash.TR_Distance:               {'db_name': 'tr_distance',               'type': 'int'},
    Hash.TR_ElevationChange:        {'db_name': 'tr_elevation_change',       'type': 'float'},
    Hash.TR_MaxElevation:           {'db_name': 'tr_elevation_max',          'type': 'float'},
    Hash.TR_MinElevation:           {'db_name': 'tr_elevation_min',          'type': 'float'},
    ...
    Hash.TR_ElevationStart:         {'db_name': 'tr_elevation_start',        'type': 'float'},
    Hash.TR_ElevationEnd:           {'db_name': 'tr_elevation_end',          'type': 'float'},
    Hash.TR_ExteriorStart:          {'db_name': 'tr_exterior_start',         'type': 'int'},
    Hash.TR_ExteriorEnd:            {'db_name': 'tr_exterior_end',           'type': 'int'},
    Hash.TR_SocDStart:              {'db_name': 'tr_socd_start',             'type': 'int'},
    Hash.TR_SocDEnd:                {'db_name': 'tr_socd_end',               'type': 'int'},
